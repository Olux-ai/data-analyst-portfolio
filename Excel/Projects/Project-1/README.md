...
The raw dataset was cleaned and transformed using \*\*Microsoft Power Query\*\*.
...
Power Query made the cleaning process more efficient and repeatable compared with manually editing individual records.
...
PivotCharts were created to communicate the findings visually.



Slicers were also used to allow the dashboard to be filtered interactively.
...
This indicates that profitability varies considerably across regions and that regional performance should be investigated individually.
...
Furniture generated significant sales but comparatively low profit.
...
Profitability varies across different months and years.



Some periods generated strong profits, while others recorded negative profitability.
...
\- \*\*October 2016:\*\* approximately $15,629 profit
...
The variation in monthly profitability suggests that factors such as seasonality, sales volume, discounts, product mix, and regional performance may influence business performance.
...
Furniture generates considerable sales but relatively low profit.
...
Technology and Office Supplies are stronger contributors to overall profit.



Management should consider giving high-performing products within these categories greater attention through:
...
Products consistently generating negative profit should be reviewed before additional resources are allocated to them.
...
One of the key findings from this analysis is that \*\*high sales do not automatically mean high profit\*\*.
